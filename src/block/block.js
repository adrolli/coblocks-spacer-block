...
/**
 * Register: GutenKit Spacer Gutenberg Block.
 *
...
registerBlockType( 'gutenkit/spacer', {
	...
	edit( { className, attributes, setAttributes, isSelected, toggleSelection } ) {
		...
		return [
			...
			inspectorControls,
			<ResizableBox
				className={ classnames( className, 'gutenkit-spacer-control' ) }
				size={ {
					width: '100%',
					height: height,
				} }
				...
				minHeight= { '100%' }
				handleClasses={ {
					bottomLeft: 'gutenkit-block-spacer-control__resize-handle',
				} }
